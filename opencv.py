...
file_list=get_list_of_files("C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\opencv-master\\opencv-master")
...
file_list=get_list_of_files("C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp")
...
MYDIR="C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\"

if not os.path.exists(MYDIR+directory):
    os.makedirs(MYDIR+directory)
def extract_all_tokens(function_call, list_of_filenames):
    #print(function_call)
    pathname="C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\"
...
for file in c_files:
    initial_filename=(os.path.basename(file).split('_'))
    leaf_pathname="C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\"
    leaf_file=leaf_pathname+initial_filename[0]+"_"+initial_filename[1]+"_"+initial_filename[2]+"_nodes.json"
    path1 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"
...
# #                 print(path[:path.index(node)])
        ...
        for i in range(len(final_solution)):
            if(final_solution[i][1]>0):
                ...
                #to be deleted later
                #print(filename)
    filename1 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\entropy.json"
    filename2 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\conditional_entropy.json"
    filename3 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\conditional_entropy1.json"
    ...
    filename4 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\imp_path1.json"
    filename5 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\not_imp1.json"
    filename6 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\not_considered1.json"
    ...
    filename7 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\imp_path.json"
    filename8 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\not_imp.json"
    filename9 = "C:\\Users\\RITIN JAISWAL\\Desktop\\Finer-Softwares-master (1)\\Finer-Softwares-master\\Libopencv\\Temp\\Entropy_Calculation\\"+str((((file.split("\\"))[8]).split("_"))[0])+"\\not_considered.json"
